...
class CreateMProfileTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('m_profile', function (Blueprint $table) {
            $table->bigIncrements('m_profile_id');
            ...
            $table->index(['meter_t0', 'local_t0', 'reg_descr_id', 'val', 'raw_unit', 'val_demand', 'val_edit', 'val_factor', 'unit', 'meter_id'], 'UX_M_PROFILE_m_profile');
